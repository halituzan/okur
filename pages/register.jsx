...
export default function Register() {
  ...
  const registerSender = async () => {
    ...
    if (studentId && password && email && firstName && lastName) {
      if (
        ...
        if (!emailCheck) {
          toast.error("Lütfen e-postanızı doğru formatta girin.");
          return;
        }
  ...
  return (
    <div className='h-screen md:flex'>
      ...
      <div className='flex flex-col sm:flex-row  md:w-1/2 justify-center py-10 items-center h-screen sm:h-auto bg-slate-200 sm:bg-white mb-20 sm:mb-0 overflow-auto'>
      ...
      <div className='fixed bottom-0 flex w-screen sm:hidden h-12'>
        <div className='flex-1 flex '>
          <button
            type='button'
            className='block w-full bg-rose-500  text-white font-semibold'
            onClick={() => registerSender()}
          >
            Kayıt Ol
          </button>
        ...
        <div className='flex content-center flex-1 '>
          <Link
            href='/login'
            className='w-full bg-emerald-500 text-white font-semibold  flex justify-center items-center'
          >
            Giriş Yap
          </Link>
        </div>
...
const studenIdIcon = (registerValues) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className={!registerValues.studentId ? "h-5 w-5 text-gray-400" : "h-5 w-5"}
    fill='none'
    viewBox='0 0 24 24'
    stroke='currentColor'
  >
...
const peopleIcon = (values) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className={!values ? "h-5 w-5 text-gray-400" : "h-5 w-5"}
    viewBox='0 0 20 20'
    fill='currentColor'
  >
    <path
...
const emailIcon = (registerValues) => (
  <svg
    xmlns='http://www.w3.org/2000/svg'
    className={!registerValues.email ? "h-5 w-5 text-gray-400" : "h-5 w-5"}
    fill='none'
    viewBox='0 0 24 24'
    stroke='currentColor'
  >
