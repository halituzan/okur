            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start">
                ...
                <a href="https://flowbite.com" className="flex ml-2 md:mr-24">
                  ...
                  <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">OkurNET</span>
                </a>
              </div>
                ...
                <div className="flex items-center ml-3">
                  <div>
                    <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                      ...
                      <Image className="w-8 h-8 rounded-full"  width={50} height={50} src="/images/profile-picture-5.jpg" alt="user photo" />
                    </button>
                  </div>
