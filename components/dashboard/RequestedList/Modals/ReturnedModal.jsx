...
import { BookReturned } from "../../../../helpers/books.helpers";
import { AiFillCloseCircle } from "react-icons/ai";

const ReturnedModal = ({ currentBook, setOpenBookBorrowed }) => {
  const returnedModalRef = useRef(null);
  return (
    <div>
        ...
        <div className="relative w-3/4 my-6 mx-auto max-w-3xl">
          ...
          >
            ...
            <div className="p-4 border-t border-rose-600">
              <button onClick={() => BookReturned(currentBook.id)}>Evet</button>
