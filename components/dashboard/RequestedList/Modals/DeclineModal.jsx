        ...
        <div className="relative w-3/4 my-6 mx-auto max-w-3xl">
          ...
          >
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-rose-600 rounded-t">
              <h3 className="text-3xl font-semibold">Kitabı Reddediyorsunuz</h3>
              <button
            ...
            <div className="p-4">
              ...
              reddediyorsunuz emin misiniz?
            </div>
            <div className="p-4 border-t border-rose-600">
              <button onClick={() => DeclineBookRequest(currentBook.id)}>
                Evet
              </button>
              <button onClick={() => setOpenDecline(false)}>İptal</button>
            </div>
          </div>
        </div>
      </div>
